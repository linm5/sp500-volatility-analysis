...
# Compile Stan Model
garch_model <- cmdstan_model("../BDA_project/4.2.garch_model.stan", force_recompile = TRUE, quiet = FALSE)
...
print(ppc)
ggsave("6.2.garch_posterior_predictive_check_original.png", plot = ppc)
