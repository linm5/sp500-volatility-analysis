...
# Compile Stan Model
arch_model <- cmdstan_model("../BDA_project/1.1.arch_priors1.stan", force_recompile = TRUE, quiet = FALSE)
...
print(ppc)
ggsave("3.1.arch_posterior_predictive_check_priors1.png", plot = ppc)
