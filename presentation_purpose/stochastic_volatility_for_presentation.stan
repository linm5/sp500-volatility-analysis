data {
    ...
    real prior_mean_log_return; // Mean of our daily returns, 
    // we use this for meaningful sampling for daily log-returns
    real<lower=0> prior_sd_log_return; // Standard deviation of our daily returns (volatility), 
    //we use this for building informative prior
}
parameters {
